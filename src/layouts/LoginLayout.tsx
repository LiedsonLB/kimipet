...
import logo2 from "/public/img/logo-kimipet.png"
import Link from "next/link";

export default function LoginLayout() {
    return (
        <div className="h-screen w-screen">
            <div className="px-6 py-4 h-screen font-montserrat text-black font-[500] text-center flex flex-col justify-between md-lg: md-lg:flex-row md-lg:justify-center md-lg:gap-8">

                <div className="flex flex-col justify-center items-center md-lg:w-[40%]">
                    <Image
                        className="md-lg:w-[20rem]"
                        style={{ margin: '0 auto' }}
                        src={logo2}
                        alt="Logo Kimipet"
                        height={90}
                ...
                <div className="flex flex-col h-full justify-around md-lg:justify-around  md-lg:w-[60%] md-lg:max-h-[80%] my-auto">
                    <div className="w-full flex flex-col justify-center items-center mb-4">
                        <Image
                            src={logo}
                            alt="Logo kimipet"
                        />
                        <p className="font-[600]">Amar, cuidar e proteger</p>
                    </div>
                    ...
                    <a href="" className="text-gray opacity-75 underline py-4 w-fit mx-auto">Esqueceu a sua senha?</a>

                    <button className="bg-orange rounded-full py-3 flex items-center justify-center gap-3 text-white text-[1rem] font-[500] border-2 border-[#fead17] hover:bg-opacity-80 transition w-full mb-4">Entrar</button>

                    <p className="text-gray opacity-75">Ou conecte com suas redes sociais</p>
                    ...
                    <p className="pt-4 font-[600]">Ainda não tem uma conta? <span className="text-orange hover:underline"><Link href="/auth/cadaster">Cadastre-se</Link></span></p>
                </div>
