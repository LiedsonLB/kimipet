...
export default function Presentation() {
    return (
        <div className="flex justify-center items-center apresention-background min-h-[35rem] md-lg:min-h-[400px]">
            <div className="font-montserrat max-w-[80%] px-1  md-lg:px-6 text-center text-white-light flex flex-col gap-5" style={{fontSize: '1.5rem', transform: 'translateY(-1rem)'}}>
