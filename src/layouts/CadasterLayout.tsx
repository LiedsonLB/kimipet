        ...
        <div className="h-screen w-screen">
            <div className="px-6 py-4 h-screen font-montserrat text-black font-[500] text-center flex flex-col justify-between md-lg: md-lg:flex-row md-lg:justify-center md-lg:gap-8">
                ...
                <div className="flex flex-col h-full justify-around md-lg:justify-around  md-lg:w-[60%] md-lg:max-h-[80%] my-auto">
                    ...
                    <h1 className="text-purple font-montserrat font-[700] my-2">Seja bem vindo, você é Novo aqui?</h1>
                    ...
                    <button className="bg-orange rounded-full py-3 flex items-center justify-center gap-3 text-white text-[1rem] font-[500] border-2 border-[#fead17] hover:bg-opacity-80 transition w-full my-4">Cadastrar</button>

                    <p className="text-gray opacity-75">Ou cadastre-se com suas redes sociais</p>
