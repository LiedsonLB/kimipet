...
export default function Header() {
  ...
  const handleAsideCloseModal = () => {
    setIsAsideModalOpen(false);
  };

  return (
    <>
      {isAsideModalOpen && <Aside onClose={handleAsideCloseModal} />}
      <div className="bg-white-light text-orange flex justify-between items-center px-6 md-lg:px-12 py-4 relative">
        <a href="/">
          <Image
            src={logo}
            alt="Logo kimipet"
        ...
        {/* Button user desktop */}
        <button onClick={handleUserButtonClick} className="hidden md-lg:block">
        ...
        {/* Button menu mobile */}
        <button onClick={handleAsideButtonClick} className="block md-lg:hidden">
